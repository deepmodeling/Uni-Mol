...
class UniMolLoss(UnicoreLoss):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        logits_encoder, encoder_distance, encoder_coord, x_norm, delta_encoder_pair_rep_norm = model(**sample[input_key], encoder_masked_tokens=masked_tokens)
        ...
        if encoder_distance is not None:
            ...
            masked_dist_loss = self.cal_dist_loss(sample, encoder_distance, dist_masked_tokens, target_key, normalize=True)
